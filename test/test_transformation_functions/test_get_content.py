...
class TestGetContent:
    def test_get_content(self):
        api_link = "https://content.guardianapis.com/search?q=machine%20learning&from-date=2023-01-01&api-key=test"
        api_key = "test"
...
class TestGetContentPreview:
    def test_get_content_preview(self):
        testUrl = "https://content.guardianapis.com/info/2023/nov/21/who-said-what-using-machine-learning-to-correctly-attribute-quotes?show-elements=all&show-fields=body&api-key=test"
